-- Dataset shape, sample rows, and column-level profile.
-- All three queries scan the full raw table (~768 MB). Run separately.

-- ================================================================
-- Overall shape: row counts, cardinality, fill rates, date range
-- ================================================================
SELECT
  COUNT(*)                                              AS total_rows,
...
-- ================================================================
-- Sample: 20 recent rows to eyeball real data shape and mess
-- ================================================================
SELECT
  complaint_id,
  date_received,
...
-- ================================================================
-- Column profile: null rates and distinct counts, single scan
